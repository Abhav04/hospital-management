...
VALUES
('Aarav Sharma', 'MALE', '1990-05-10', 'aarav.sharma@example.com','A_POSITIVE'),
('Diva Patel', 'FEMALE', '1995-08-20', 'diya.patel@example.com','A_POSITIVE' ),
 ...
 ('Neha Iyer', 'FEMALE', '1992-12-01', 'neha.iyer@example.com','A_POSITIVE'),
  ('Kabir Singh', 'MALE', '1993-07-11', 'kabir.singh@example.com','A_POSITIVE');
INSERT INTO doctor (name, specialization, email)
VALUES
('Dr. Rakesh Mehta', 'Cardiology', 'rakesh.mehta@example.com'),
('Dr. Sneha Kareec', 'Dermatology', 'sneha.kapoor@example.com'),
