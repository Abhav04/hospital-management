...
import com.codingshuttle.hospital.management.dto.BloodGroupCountResponseEntity;
...
public interface PatientRepository extends JpaRepository<Patient,Long> {
    ...
    @Query("select new com.codingshuttle.hospital.management.dto.BloodGroupCountResponseEntity(p.bloodGroup," +
